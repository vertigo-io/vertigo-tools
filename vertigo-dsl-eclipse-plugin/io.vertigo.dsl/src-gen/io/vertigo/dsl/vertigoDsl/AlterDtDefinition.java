 ...
 *   <li>{@link io.vertigo.dsl.vertigoDsl.AlterDtDefinition#getDtDefinitionStaticValues <em>Dt Definition Static Values</em>}</li>
 * </ul>
 *
...
public interface AlterDtDefinition extends Element
{
   ...
   * @see io.vertigo.dsl.vertigoDsl.VertigoDslPackage#getAlterDtDefinition_DtDefinitionStaticValues()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link io.vertigo.dsl.vertigoDsl.AlterDtDefinition#getDtDefinitionStaticValues <em>Dt Definition Static Values</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
