...
public interface VertigoDslFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Faceted Query Definition Dt Index</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Faceted Query Definition Dt Index</em>'.
   * @generated
   */
  FacetedQueryDefinitionDtIndex createFacetedQueryDefinitionDtIndex();
