...
entryRuleFacetedQueryDefinitionDtIndex returns [EObject current=null]:
	...
	{ $current=$iv_ruleFacetedQueryDefinitionDtIndex.current; }
	EOF;

// Rule FacetedQueryDefinitionDtIndex
ruleFacetedQueryDefinitionDtIndex returns [EObject current=null]
@init {
	enterRule();
}
@after {
