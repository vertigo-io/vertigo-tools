...
@after {
	...
	(
		...
		{
			$current = $this_AlterDomain_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FileInfo_2.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_DeclaredDomain_3.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_DtDefinition_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_DeclaredDtDefinition_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_AlterDtDefinition_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_AssociationNN_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_TaskDefinition_9.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FacetDefinition_10.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_IndexDefinition_11.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_FacetedQueryDefinition_12.current;
			afterParserOrEnumRuleCall();
		}
	)
;
				...
				{getUnorderedGroupHelper().canSelect(grammarAccess.getDtDefinitionComputedFieldStringAccess().getUnorderedGroup_1(), 3)}?=>(
					{
						getUnorderedGroupHelper().select(grammarAccess.getDtDefinitionComputedFieldStringAccess().getUnorderedGroup_1(), 3);
								...
								(
									(
										lv_expressionString_16_0=RULE_STRING
										{
...
entryRuleDtDefinitionStaticValues returns [EObject current=null]:
	...
	{ $current=$iv_ruleDtDefinitionStaticValues.current; }
	EOF;

// Rule DtDefinitionStaticValues
ruleDtDefinitionStaticValues returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleAssociationNN returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getAssociationNNRule()); }
	iv_ruleAssociationNN=ruleAssociationNN
	{ $current=$iv_ruleAssociationNN.current; }
	EOF;

// Rule AssociationNN
ruleAssociationNN returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTaskInAttribute returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTaskInAttributeRule()); }
	iv_ruleTaskInAttribute=ruleTaskInAttribute
	{ $current=$iv_ruleTaskInAttribute.current; }
	EOF;

// Rule TaskInAttribute
ruleTaskInAttribute returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTaskOutAttribute returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTaskOutAttributeRule()); }
	iv_ruleTaskOutAttribute=ruleTaskOutAttribute
	{ $current=$iv_ruleTaskOutAttribute.current; }
	EOF;

// Rule TaskOutAttribute
ruleTaskOutAttribute returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTaskClassName returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTaskClassNameRule()); }
	iv_ruleTaskClassName=ruleTaskClassName
	{ $current=$iv_ruleTaskClassName.current; }
	EOF;

// Rule TaskClassName
ruleTaskClassName returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleTaskRequest returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getTaskRequestRule()); }
	iv_ruleTaskRequest=ruleTaskRequest
	{ $current=$iv_ruleTaskRequest.current; }
	EOF;

// Rule TaskRequest
ruleTaskRequest returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
ruleAssociationTypeString returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
