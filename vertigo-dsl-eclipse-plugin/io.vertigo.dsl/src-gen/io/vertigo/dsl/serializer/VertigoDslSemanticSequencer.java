...
public class VertigoDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == VertigoDslPackage.eINSTANCE)
			...
			case VertigoDslPackage.ALTER_TASK_DEFINITION:
				sequence_AlterTaskDefinition(context, (AlterTaskDefinition) semanticObject); 
				return; 
			...
			case VertigoDslPackage.DT_DEFINITION_STATIC_VALUES:
				sequence_DtDefinitionStaticValues(context, (DtDefinitionStaticValues) semanticObject); 
				return; 
			...
			case VertigoDslPackage.FACETED_QUERY_DEFINITION_DOMAIN_CRITERIA:
				...
				return; 
			case VertigoDslPackage.FACETED_QUERY_DEFINITION_DT_INDEX:
				sequence_FacetedQueryDefinitionDtIndex(context, (FacetedQueryDefinitionDtIndex) semanticObject); 
				return; 
			...
			case VertigoDslPackage.TASK_CLASS_NAME:
				sequence_TaskClassName(context, (TaskClassName) semanticObject); 
				return; 
	...
	/**
	 * Contexts:
	 *     DtDefinitionStaticValues returns DtDefinitionStaticValues
	 *
	 * Constraint:
	 *     handleField=STRING
	 */
	protected void sequence_DtDefinitionStaticValues(ISerializationContext context, DtDefinitionStaticValues semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, VertigoDslPackage.Literals.DT_DEFINITION_STATIC_VALUES__HANDLE_FIELD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, VertigoDslPackage.Literals.DT_DEFINITION_STATIC_VALUES__HANDLE_FIELD));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDtDefinitionStaticValuesAccess().getHandleFieldSTRINGTerminalRuleCall_2_0(), semanticObject.getHandleField());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     FacetedQueryDefinitionDtIndex returns FacetedQueryDefinitionDtIndex
	 *
	 * Constraint:
	 *     dtDefinition=[DtDefinitionType|ID]
	 */
	protected void sequence_FacetedQueryDefinitionDtIndex(ISerializationContext context, FacetedQueryDefinitionDtIndex semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, VertigoDslPackage.Literals.FACETED_QUERY_DEFINITION_DT_INDEX__DT_DEFINITION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, VertigoDslPackage.Literals.FACETED_QUERY_DEFINITION_DT_INDEX__DT_DEFINITION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFacetedQueryDefinitionDtIndexAccess().getDtDefinitionDtDefinitionTypeIDTerminalRuleCall_2_0_1(), semanticObject.eGet(VertigoDslPackage.Literals.FACETED_QUERY_DEFINITION_DT_INDEX__DT_DEFINITION, false));
		feeder.finish();
	}
	 ...
	 *     className=STRING
	 */
	protected void sequence_TaskClassName(ISerializationContext context, TaskClassName semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, VertigoDslPackage.Literals.TASK_CLASS_NAME__CLASS_NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, VertigoDslPackage.Literals.TASK_CLASS_NAME__CLASS_NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTaskClassNameAccess().getClassNameSTRINGTerminalRuleCall_2_0(), semanticObject.getClassName());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     TaskRequest returns TaskRequest
	 *
	 * Constraint:
	 *     request=TaskRequestString
	 */
	protected void sequence_TaskRequest(ISerializationContext context, TaskRequest semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, VertigoDslPackage.Literals.TASK_REQUEST__REQUEST) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, VertigoDslPackage.Literals.TASK_REQUEST__REQUEST));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getTaskRequestAccess().getRequestTaskRequestStringParserRuleCall_2_0(), semanticObject.getRequest());
		feeder.finish();
	}
